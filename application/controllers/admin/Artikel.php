...
class Artikel extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'PostManager/Artikel/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'PostManager/Artikel/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'PostManager/Artikel/index.html';
            $config['first_url'] = base_url() . 'PostManager/Artikel/index.html';
        }
    ...
    public function read($id) 
    {
        ...
        $this->load->view('layouts/main', $data);
            ...
            redirect(site_url('PostManager/Artikel'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('PostManager/Artikel/create_action'),
	    'id' => set_value('id'),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('PostManager/Artikel/update_action'),
		'id' => set_value('id', $row->id),
		'caption' => set_value('caption', $row->caption),
 		'gambar' => set_value('gambar', $row->gambar),
		'keterangan' => set_value('keterangan', $row->keterangan),
		'no_konten' => set_value('keterangan', $row->no_konten),
...
// 	$this->form_validation->set_rules('gambar', 'gambar', 'trim|required');
    ...
    $this->form_validation->set_rules('no_konten', 'no_konten', 'trim');
