...
<div class="outer">
    <div class="inner bg-light lter bg-container">
        ...
        <div class="form-group">
            <label for="varchar">Nomor Konten <?php echo form_error('no_konten') ?></label>
            <input type="text" class="form-control" name="no_konten" id="no_konten" placeholder="Nomor Konten" value="<?php echo $no_konten; ?>" />
        </div>
	    <div class="form-group">
    ...
    <input type="hidden" name="tgl_post" id="tgl_post"  value="<?php echo $tgl; ?>" />
	    ...
	    <a href="<?php echo site_url('PostManager/Beritahariini') ?>" class="btn btn-default">Cancel</a>
	</form>
