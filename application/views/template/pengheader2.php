		...
		<div class="container">
			<div class="mbr-cards-row row">
				<div class="mbr-cards-col col-lg-4 col-xs-4" id="sgrid">
					<div class="container">
						<a id="c908" href="<?php echo $u->link1 ?>">
						<div class="card-img">
							<img id="c918" src="<?php echo base_url(); ?>public/img/assetImage/1711012124128.png"/>
						</div>
				...
				<div class="mbr-cards-col col-lg-4 col-xs-4" id="c926">
					<div class="container">
						<a id="c934" href="<?php echo $u->link2 ?>">
						<div class="card-img">
							<img id="c943" src="<?php echo base_url(); ?>public/img/assetImage/1711172020038.png"/>
						</div>
