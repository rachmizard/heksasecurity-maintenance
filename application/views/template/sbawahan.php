  ...
  <script type=<?php echo base_url(); ?>"text/javascript" src="assets/js/owl.carousel.js"></script>
  <script src="<?php echo base_url(); ?>https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5"></script>
  <script src="<?php echo base_url(); ?>https://apis.google.com/js/plusone.js"></script>
  <script src="<?php echo base_url(); ?>assets/facebook-plugin/facebook-script.js"></script>
  
 <script src="assets/theme/js/jquery.star-rating-svg.js"></script>
  <script>
      $(function() {
