...
<div class="outer">
    <div class="inner bg-light lter bg-container">
        ...
        <h2 style="margin-top:0px">Beritahariini Read</h2>
        <table class="table">
	    <tr><td>Judul</td><td><?php echo $caption; ?></td></tr>
	    <tr><td>Gambar</td>
	    ...
	    <tr><td>Konten</td><td><?php echo $keterangan; ?></td></tr>
	    <tr><td></td><td><a href="<?php echo site_url('PostManager/Artikel') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
