...
<div class="cont menu-wrap" style="position: fixed;">
			...
			<a href="about"><i class="fa fa-fw fa-question-circle"></i><span>About Us</span></a>
			<a href="mitra"><i class="fa fa-fw fa-handshake-o"></i><span>Mitra</span></a>
			<a href="pengamanan"><i class="fa fa-fw fa-shield"></i><span>Pengamanan</span></a>
			<a href="pelatihan"><i class="fa fa-fw fa-bullhorn"></i><span>Pelatihan</span></a>
			<a href="artikel"><i class="fa fa-fw fa-book"></i><span>Artikel & Berita</span></a>
			<a href="testimoni"><i class="fa fa-fw fa-star"></i><span>Testimoni</span></a>
			<a href="gallery"><i class="fa fa-fw fa-camera-retro"></i><span>Gallery</span></a>
			<a href="karir"><i class="fa fa-fw fa-users"></i><span>Karir</span></a>
			<a href="contact"><i class="fa fa-fw fa-phone-square"></i><span>Kontak</span></a>
					</div>
...
<a href="https://www.google.co.id/maps/place/PT.+Heksa+Garda+Utama/@-6.9582819,107.652155,15z/data=!4m5!3m4!1s0x0:0xec964a23cdea917d!8m2!3d-6.9582819!4d107.652155"><i style="   font-size: 21px; padding-left: 19px" class="fa fa-fw fa-google-plus"></i></a>
	...
	<div class="col-xs-10 col-xs-offset-0" style=";z-index: 2;position: absolute; padding: " >
...
<script type="text/javascript" src="assets/js/jquery.flagstrap.js" ></script>
<script>$('.dropdown-toggle').dropdown()</script>
