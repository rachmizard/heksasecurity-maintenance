...
<section style="padding-top: 20%;background-color:#cbcac9;padding-bottom: 3%;">
    ...
    <center style="padding-top: 20px; "> <h4 style="font-weight: bold;"> <?php echo $u->sambutan ?></h4> </center>
             ...
             <div class="mbr-cards-row row" style="padding-bottom: 40px;padding-top: 0px;">
                ...
                <a href="<?php foreach($home as $u){ ?><?php echo $u->txt_header; ?><?php } ?>" style="text-decoration: none;color: white;">
                ...
                <a href="<?php foreach($home as $u){ ?><?php echo $u->txt_header2; ?><?php } ?>" style="text-decoration: none;">
                ...
                <a data-toggle="modal" data-target=".bs-example-modal-md" style="text-decoration: none;">

                    <img src="<?php echo base_url(); ?>assets/images/jadwal_pelatihan.png" style="width: 100%; margin-top: 15%;">
                        ...
                        <p style="margin-top: -23%;">
                            ...
                            <span style="color: red;"><?php echo $u->captionb3 ?></span><br>
                            ...
                            <span style="color: white;"><?php echo $u->captionr3 ?></span>
...
<div class="modal fade bs-example-modal-md" aria-labelledby="myLargeModalLabel">
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <img src="<?php echo base_url(); ?>assets/images/jadwal.png" style="height: 126px;"/>
