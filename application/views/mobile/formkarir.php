...
$(document).ready(function () {
    ...
    $("#add-more").click(function(e){
        ...
        next = next + 1;
        var newIn = ' <div id="field'+ next +'" name="field'+ next +'"><div class="col-xs-6"> <label>No</label> <input type="text" id="text" placeholder="No" style="width: 100%; padding: 10px; margin-bottom: 15px;"> </div> <div class="col-xs-6"> <label>Nama Perusahaan</label> <input type="text" id="text" name="perusahaan" placeholder="Nama Perusahaan" style="width: 100%; padding: 10px; margin-bottom: 15px;" <?php echo set_value('perusahaan'); ?>> </div> <div class="col-xs-6"> <label>Masa Kerja</label> <input type="text" id="text" name="masa_kerja" placeholder="Masa Kerja" style="width: 100%; padding: 10px; margin-bottom: 15px;" <?php echo set_value('masa_kerja'); ?>> </div> <div class="col-xs-6"> <label>Tahun</label> <input type="text" id="text" name="tahun" placeholder="Tahun" style="width: 100%; padding: 10px; margin-bottom: 15px;" <?php echo set_value('tahun'); ?>> </div> <div class="col-xs-6"> <label>Jabatan</label> <input type="text" id="text" name="jabatan" placeholder="Jabatan" style="width: 100%; padding: 10px; margin-bottom: 15px;" <?php echo set_value('jabatan'); ?>> </div>';
        var newInput = $(newIn);
