...
<div class="outer">
    <div class="inner bg-light lter bg-container">
        ...
        <h2 style="margin-top:0px">Home <?php echo $button ?></h2>
        ...
        <div class="form-group">
            <label for="varchar">Caption Black 3 <?php echo form_error('captionb3') ?></label>
            <input type="text" class="form-control" name="captionb3" id="captionb3" placeholder="captionb3" value="<?php echo $captionb3; ?>" />
        </div>
        <div class="form-group">
            <label for="varchar">Caption Red 2 <?php echo form_error('captionr3') ?></label>
            <input type="text" class="form-control" name="captionr3" id="captionr3" placeholder="captionr3" value="<?php echo $captionr3; ?>" />
        </div>
        <div class="form-group">
	    ...
	    <a href="<?php echo site_url('PostManager/Home/') ?>" class="btn btn-warning">Cancel</a>
	</form>
