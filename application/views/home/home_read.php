    ...
    <div class="inner bg-light lter bg-container">
        <div class="row">
            <div class="col-12 data_tables">
                <div class="card">
                     <h2 style="margin-top:0px">Home Read</h2>
                        <table class="table">
                            ...
                            <tr><td>caption black 3</td><td><?php echo $captionb3; ?></td></tr>
                            <tr><td>caption red 3</td><td><?php echo $captionr3; ?></td></tr>
                    	    ...
                    	    <tr><td></td><td><a href="<?php echo site_url('PostManager/Home/') ?>" class="btn btn-warning ">Back</a></td></tr>
            	       </table>
                </div>
            </div>
        </div>
